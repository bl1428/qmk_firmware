...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |------+------+------+------+------+------|------+------+------+------+------+------|
  * | Shift|Meh(Z)|   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
  * |------+------+------+------+------+------+------+------+------+------+------+------|
  * | Esc  | Meh  | GUI  | Alt  |Lower |    Space    |Raise |  -   |  =   |  (   |   )  |
  * `-----------------------------------------------------------------------------------'
  */
  [_QWERTY] = LAYOUT_preonic_1x2uC(HYPR_T(KC_GRV), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, 
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_DEL,
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SFTENT, 
    KC_ESC, KC_MEH, KC_LGUI, KC_LALT, LOWER, KC_SPC, RAISE, KC_MINS, KC_EQL, KC_LPRN, KC_RPRN
  ),
  ...
  * |------+------+------+------+------+------|------+------+------+------+------+------|
  * | Shift|Meh(Z)|   X  |   C  |   V  |   B  |   K  |   M  |   ,  |   .  |   /  |Enter |
  * |------+------+------+------+------+------+------+------+------+------+------+------|
  * | Esc  | Meh  | GUI  | Alt  |Lower |    Space    |Raise |  -   |  =   |  (   |   )  |
  * `-----------------------------------------------------------------------------------'
  */
  [_COLEMAK] = LAYOUT_preonic_1x2uC(HYPR_T(KC_GRV), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, 
  ...
  * |------+------+------+------+------+------|------+------+------+------+------+------|
  * | Shift|Meh(;)|   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |Enter |
  * |------+------+------+------+------+------+------+------+------+------+------+------|
  * | Esc  | Hyper| GUI  | Alt  |Lower |    Space    |Raise |  -   |  =   |  (   |   )  |
  * `-----------------------------------------------------------------------------------'
  */
  [_DVORAK] = LAYOUT_preonic_1x2uC(HYPR_T(KC_GRV), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, 
  ...
  * |------+------+------+------+------+-------------+------+------+------+------+------|
  * | Tab  | Home |  Up  | End  |Pg up |      |      |      |      |      |      |Prntsc|
  * |------+------+------+------+------+-------------+------+------+------+------+------|
  * | Ctrl | Left | Down |Right |Pg dn |      |      |      |      |      |      |Bslash|
  * |------+------+------+------+------+------|------+------+------+------+------+------|+
  ...
  */
  [_LOWER] = LAYOUT_preonic_1x2uC(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
    KC_TRNS, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR,
    KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLASH,
    KC_TRNS, KC_BSPC, KC_DEL, KC_ENT, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_NO,
    KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_LGUI, KC_TRNS, KC_TRNS, KC_NO, KC_LBRC, KC_RBRC
  ),
  ...
  */
  [_RAISE] = LAYOUT_preonic_1x2uC(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NLCK, KC_PSLS, KC_P7, KC_P8, KC_P9, KC_BSPC,
    ...
    KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC, KC_TRNS, KC_TRNS, KC_NO, KC_LCBR, KC_RCBR
  ),
  ...
  * |------+------+------+------+------+-------------+------+------+------+------+------|
  * |      |      |MuMode|Aud on|AudOff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|      |      |
  * |------+------+------+------+------+------|------+------+------+------+------+------|
